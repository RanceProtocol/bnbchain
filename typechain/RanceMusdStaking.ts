...
export interface RanceMusdStakingInterface extends utils.Interface {
  functions: {
...
export interface RanceMusdStaking extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RanceMusdStakingInterface;
